...
#' @param zones_ts character; path to Excel or CSV table (must be outside the input folder) that relates the administrative units to the different scenarios. Two columns:
