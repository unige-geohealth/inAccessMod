...
# Operationality ------------------------------
building <- list(categories = c("Not damaged", "Partially damaged", "Fully damaged"),
                 grepImpair = "partially|fully",
                 causes = c("Natural disaster", "Man-made disaster", "Conflict/attack/looting", "Lack of maintenance", "Others"),
                 stopFiltering = "Fully damaged",
                 msg = "the causes of damage")


functionality <- list(categories = c("Fully functioning", "Partially functioning", "Not functioning"),
                      grepImpair = "partially|not",
                      causes = c("Lack of staff to provide health services", 
                                "Lack of medical supplies (drugs and consumables)", 
                                "Lack of medical equipment (incl. logistics, fuel, vehicle)", 
                                "Lack of maintenance",
                                "Lack of physical access",
                                "Lack of security",
                                "Lack of finances to operate the health facility",
...
accessibility <- list(categories = c("Fully accessible", "Partially accessible", "Not accessible"),
                      ...
                      causes = c("Security situation", 
                                 "Physical barriers such as: broken bridges, flooded roads, and hard to reach places", 
                                 "Financial (Fees for patients): the service cost is a burden for patients", 
                                 "Cultural barriers",
